<div class="page">
    <div class="page-header">
        <h2>Store Condition Types</h2>
        <button class="btn btn-primary" wire:click="create">New Type</button>
    </div>
            ...
            <form wire:submit.prevent="save">
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input class="input" type="text" wire:model="form.color" placeholder="#8b5cf6">
                    </div>
                    <div class="form-group">
